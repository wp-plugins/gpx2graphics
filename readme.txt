=== Plugin Name ===
Contributors:jwenl
Donate link: http://janwillemeshuis.nl/jwe-new-media-solutions/wordpress-plugins/gpx2graphics-plugin/
...
1. Upload the directory Gpx2Graphics` to the `/wp-content/plugins/` directory
...
1. Example of the Google Map in your post
2. Example of the elevation image
